<ul class="nav nav-pills flex-column">
  @foreach($root_folders as $root_folder)
    <li class="nav-item">
      <a class="nav-link" href="javascript:;" data-type="0" onclick="moveToNewFolder(`{{$root_folder->url}}`)">
    ...
    <li class="nav-item sub-item">
      <a class="nav-link" href="javascript:;" data-type="0" onclick="moveToNewFolder(`{{$directory->url}}`)">
