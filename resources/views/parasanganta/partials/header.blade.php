                ...
                <div class="col-lg-2">
                    <div class="footer-widget footer-widget__links">
                        ...
                        <ul class="footer-widget__links-list list-unstyled">
                            <li>
                                <a href="{{route('tentangbenda')}}">Benda</a>
                            </li>
                            <li>
                                <a href="{{route('tentangbangunan')}}">Bangunan</a>
                            </li>
                            <li>
                                <a href="{{route('tentangstruktur')}}">Struktur</a>
                            </li>
                            <li>
                                <a href="{{route('tentangsitus')}}">Situs</a>
                            </li>
                            <li>
                                <a href="{{route('tentangkawasan')}}">Kawasan</a>
                            </li>
                            <li>
                                <a href="{{route('tentangkegiatan1')}}">Kegiatan</a>
                            </li>
        ...
        <div class="container">
            <div class="inner-container">
                ...
                <a href="{{ route('home') }}" class="site-footer__bottom-logo">
                    <img src="assets/images/resources/logo-makassar.webp" alt="" width="60">
                </a>
