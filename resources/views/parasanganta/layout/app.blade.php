...
<body>
    ...
    @yield('content')
    @include('parasanganta.partials.footer')
    {{-- Footer --}}
    </div><!-- /.page-wrapper -->
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            ...
            <a href="{{ route('parasanganta') }}" class="side-menu__logo"><img src="{{ asset('assets/images/logo/logo-parasanganta2.svg') }}" alt="" width="170"></a>
