  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Divider -->
    @if (Auth::user()->role == 'adminParasanganta' || Auth::user()->role == 'superAdmin')
    ...
    @if (Auth::user()->role == 'adminLabu' || Auth::user()->role == 'superAdmin')
    <!-- Divider -->
    ...
    @if (Auth::user()->role == 'adminParasanganta' || Auth::user()->role == 'superAdmin' || Auth::user()->role == 'adminLabu')
