              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <div class="row">
                      <div class="col-6">
                        <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">List Konten Labu</h2>
                      </div>
                      <div class="col-6 text-end">
                        <a href="{{ route('admin.konten_labu.add') }}" class="btn btn-primary">
    ...
    $(document).on('click', '.btn-hapus', function(e) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.location.href = `/admin/labu/konten/delete/${id}`
          Swal.fire(
            'Deleted!',
