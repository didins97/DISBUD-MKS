...
@section('content')
      <form method="post" action="{{ route('admin.konten_labu.store') }}" enctype="multipart/form-data">
        @csrf
        <!-- Begin Page Content -->
        <div class="container-fluid" id="contentWrapper">
            ...
            <div class="row">
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">Tambah konten labu</h2>
                  </div>
                  <div class="card-body">
                      <div class="mb-3">
                        <label for="judulArtikelBahasa" class="form-label">Nama</label>
                        <input required value="{{ old('judul') }}" type="text" name="judul" class="form-control" id="judulArtikelBahasa" placeholder="masukkan judul konten labu">
                      </div>
                      <div class="mb-3">
                        <label for="isiArtikelBahasa" class="form-label">Konten</label>
                        <textarea required class="form-control editor" name="isi" id="editor" rows="8">{{ old('isi') }}</textarea>
                      </div>
                        <div class="mb-3">
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">Tag Konten</h2>
                  </div>
                  <div class="card-body">
                      <div class="mb-3">
                        ...
                        <div class="px-3 row">
                          <div class="col-lg-4">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="is_wbtb" id="is_wbtb1" value="1" checked>
                              <label class="form-check-label" for="is_wbtb1">
                                Konten WBTB
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="is_wbtb" id="is_wbtb2" value="0">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="px-3 row">
                          <div class="col-lg-4">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="kategori_opk[]" value="{{ $k->id }}" id="flexCheckDefault">
