...
@section('content')
      <form method="post" action="{{ route('admin.kegiatan1.update', $foto->id) }}" enctype="multipart/form-data">
        @csrf
        <!-- Begin Page Content -->
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">Edit Kegiatan</h2>
                  </div>
                  <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea required class="form-control editor" name="letak" id="editor" rows="8">{{$foto->letak}}</textarea>
                      </div>
                      <div class="mb-3">
