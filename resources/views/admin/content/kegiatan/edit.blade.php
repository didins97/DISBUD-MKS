              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">EDIT EVENT</h2>
                  </div>
                  <div class="card-body">
                    {{-- <div class="col-lg-12 mb-3"> --}}
                      {{-- <div class="card shadow mb-4"> --}}
                    ...
                    {{-- </div> --}}
                      <div class="mb-3">
                        <label for="judulArtikelBahasa" class="form-label">Judul Event</label>
                        <input required value="{{ $kegiatan->judul_indo }}" type="text" name="judul_indo" class="form-control" id="judulArtikelBahasa" placeholder="masukkan judul event">
                      </div>
                      <div class="row mb-3">
                        <div class='col-lg-6'>
                          <label for="tanggalPublish" class="form-label">Tanggal Event</label>
                          <input required value="{{$kegiatan->date_event}}" name="date_event"  type="text" class="form-control" id="tanggalPublish">
                        </div>
                        <div class='col-lg-6'>
                          <label for="waktuPublish" class="form-label">Waktu Event</label>
                          <input required value="{{$kegiatan->time_event}}" name="time_event"  type="text" class="form-control" id="waktuPublish">
                        </div>
                      </div>
                      <div class="mb-3">
                        <label for="judulArtikelBahasa" class="form-label">Tempat Event</label>
                        <input required value="{{ $kegiatan->venue }}" type="text" name="venue" class="form-control" id="judulArtikelBahasa" placeholder="masukkan judul event">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input name="keywords_indo" value="{{ $kegiatan->keywords_indo }}" id="keywordsID" type="text" class="form-control tagin">
