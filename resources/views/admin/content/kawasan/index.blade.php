                  ...
                  <div class="card-header py-3">
                    <div class="row">
                      ...
                      <div class="col-6 text-end">
                        ...
                        <a href="{{ route('admin.konten.cetak') }}?cetak=Kawasan" class="btn btn-sm btn-outline-info mb-1">
                          Cetak
                        </a>
                      </div>
                    </div>
                    ...
                    <table id="listArtikel" class="table" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('kawasan_detail', $f->slug) }}" class="btn btn-sm btn-outline-primary mb-1">
                              View
                            </a>
