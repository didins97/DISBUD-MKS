...
@section('content')
      <form method="post" action="{{ route('admin.kawasan.store') }}" enctype="multipart/form-data">
        @csrf
        <!-- Begin Page Content -->
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">Tambah Kawasan</h2>
                  </div>
                  <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input  value="{{ old('nama_lain') }}" type="text" name="nama_lain" class="form-control" id="judulArtikelBahasa" placeholder="masukkan nama lain kawasan">
                    </div>
                    <div class="mb-3">
