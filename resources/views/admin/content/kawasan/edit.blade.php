...
@section('content')
      <form method="post" action="{{ route('admin.kawasan.update', $foto->id) }}" enctype="multipart/form-data">
        @csrf
        <!-- Begin Page Content -->
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">Edit Kawasan</h2>
                  </div>
                  <div class="card-body">
                    <div class="mb-3">
                      <label for="judulArtikelBahasa" class="form-label">Nama</label>
                      <input required value="{{$foto->nama }}" type="text" name="nama" class="form-control" id="judulArtikelBahasa" >
                    </div>
                    <div class="mb-3">
                      <label for="judulArtikelBahasa" class="form-label">Nama Lain</label>
                      <input required value="{{$foto->nama_lain }}" type="text" name="nama_lain" class="form-control" id="judulArtikelBahasa" >
                    </div>
                    <div class="mb-3">
                      <label for="isiArtikelBahasa" class="form-label">Konten</label>
                      <textarea required class="form-control editor" name="konten" id="editor" rows="8">{{$foto->konten}}</textarea>
                    </div>
                    <div class="mb-3">
                      <label for="judulArtikelBahasa" class="form-label">Tahun Dibuat</label>
                      <input required value="{{$foto->tahun }}" type="text" name="tahun" class="form-control" id="judulArtikelBahasa" >
                    </div>
                      <div class="mb-3">
                        <label for="isiArtikelBahasa" class="form-label">Letak</label>
                        <textarea required class="form-control" name="letak" id="editor" rows="8">{{$foto->letak}}</textarea>
                      </div>
                      <div class="mb-3">
                        <label for="judulArtikelBahasa" class="form-label">kelurahan</label>
                        <input required value="{{ $foto->kelurahan }}" type="text" name="kelurahan" class="form-control" id="judulArtikelBahasa" >
                      </div>
                      <div class="mb-3">
                        <label for="judulArtikelBahasa" class="form-label">kecamatan</label>
                        <input required value="{{ $foto->kecamatan }}" type="text" name="kecamatan" class="form-control" id="judulArtikelBahasa" >
                      </div>
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4" id="containerSliderFoto">
                  ...
                  <div class="card-body row" id="fotoSliderBody">
                    @php
                    for( $i = 0; $i < count(unserialize($foto->galleries)); $i++ ) : @endphp
                    @if( $i != 0 )
                      <div class="col-md-12 wrapper-foto-slider" data-id="{{ $i + 1 }}">
                        <div class="row">
                          <div class="col-sm-4">
                            <img class="sliderPreview" src="{{ asset('storage/assets/foto/galleries/' . unserialize($foto->galleries)[$i] ) }}" width="100%">
                          </div>
                          <div class="col-sm-7">
                            <div class="row">
                              <div class="col-12 mb-2">
                                <input value="{{ asset('storage/assets/foto/galleries/' . unserialize($foto->galleries)[$i]) }}" class="form-control" name="galleries_foto[]" id="uploadThumbnail" type="file" data-preview=".sliderPreview" accept="image/png, image/jpeg">
                              </div>
                              <div class="col-12 mb-2">
                                <textarea name="caption_galleries_foto[]" required maxlength="100" class="form-control" id="captionFoto" rows="2" placeholder="masukkan caption disini">{{ unserialize($foto->caption_galleries)[$i] }}</textarea>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-7">
                          <div class="row">
                            ...
                            {{-- <div class="col-12 mb-2">
                              <textarea name="caption_galleries_english[]" maxlength="100" class="form-control" id="captionFotoEn" rows="2" placeholder="insert caption here">{{ is_null($foto->caption_slider_foto_english) ? '' : unserialize($foto->caption_slider_foto_english)[$i] }}</textarea>
                              <little><sup>*</sup>english caption, max 100 character</little>
                            </div> --}}
                          </div>
                        </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-7">
                  <div class="row">
                    ...
                    <div class="col-12 mb-2">
                      <textarea name="caption_galleries_foto[]"   maxlength="100" class="form-control" id="captionFoto" rows="2" placeholder="masukkan caption disini" name="captionFoto` + i + `"></textarea>
                      <little><sup>*</sup> maksimsal 100 karakter</little>
                    </div>
