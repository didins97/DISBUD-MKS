              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <div class="row">
                      <div class="col-6">
                        <h2 class="m-0 font-weight-bold sub-judul">List Bangunan</h2>
                      </div>
                    ...
                    <table id="listArtikel" class="table" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('bangunan_detail', $f->slug) }}" class="btn btn-sm btn-outline-primary mb-1">
                              View
                            </a>
                            <a href="{{ route('admin.bangunan.edit', $f->id) }}" class="btn btn-sm btn-outline-info mb-1">
                              Edit
                            </a>
                            <a href="{{ route('admin.konten.cetak', $f->slug) }}?cetak=bangunan" class="btn btn-sm btn-outline-info mb-1">
                              <i class="fa fa-print mr-1"></i> Cetak
                            </a>
    ...
    $(document).on('click', '.btn-hapus', function(e) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          window.location.href = `/admin/parasanganta/bangunan/delete/${id}`
          Swal.fire(
            'Deleted!',
