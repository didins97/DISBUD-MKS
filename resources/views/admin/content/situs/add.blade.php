...
@section('content')
      <form method="post" action="{{ route('admin.situs.store') }}" enctype="multipart/form-data">
        @csrf
        <!-- Begin Page Content -->
              ...
              <div class="col-lg-12 mb-3">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-header py-3">
                    <h2 class="m-0 font-weight-bold text-gray-800 sub-judul">Tambah Situs</h2>
                  </div>
                  <div class="card-body">
                    <div class="mb-3">
                      <label for="judulArtikelBahasa" class="form-label">Nama</label>
                      <input required value="{{ old('nama') }}" type="text" name="nama" class="form-control" id="judulArtikelBahasa" placeholder="masukkan nama situs">
                    </div>
                    <div class="mb-3">
                      <label for="judulArtikelBahasa" class="form-label">Nama Lain</label>
                      <input  value="{{ old('nama_lain') }}" type="text" name="nama_lain" class="form-control" id="judulArtikelBahasa" placeholder="masukkan nama lain situs">
                    </div>
                    <div class="mb-3">
