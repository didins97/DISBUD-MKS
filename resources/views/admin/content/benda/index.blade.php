                  ...
                  <div class="card-header py-3">
                    <div class="row">
                      ...
                      <div class="col-6 text-end">
                        ...
                        {{-- <a href="{{ route('admin.konten.cetak') }}?cetak=Benda" class="btn btn-secondary bg-success">
    ...
    $(document).on('click', '.btn-vqr', function(e) {
      ...
      $($.ajax({
        ...
        success: function (response) {
          ...
          $('#modal .modal-footer').find('a').attr('href', `/admin/parasanganta/konten/cetak/${response.slug}?cetak=benda`);
          $('#modal').modal('show');
        }
      }));
    });
