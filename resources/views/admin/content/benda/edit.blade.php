                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input  value="{{$foto->nama_lain }}" type="text" name="nama_lain" class="form-control" id="judulArtikelBahasa" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input  value="{{$foto->tahun }}" type="text" name="tahun" class="form-control" id="judulArtikelBahasa" >
                    </div>
                      <div class="mb-3">
                        <label for="isiArtikelBahasa" class="form-label">Letak</label>
                        <textarea  class="form-control" name="letak" id="editor" rows="8">{{$foto->letak}}</textarea>
                      </div>
                      <div class="mb-3">
                        <label for="judulArtikelBahasa" class="form-label">kelurahan</label>
                        <input  value="{{ $foto->kelurahan }}" type="text" name="kelurahan" class="form-control" id="judulArtikelBahasa" >
                      </div>
                      <div class="mb-3">
