...
class FotoController extends Controller
{
    public function index()
    {
        ...
        if( Session::get('lg') == 'en' ){
            ...
            if( Paginator::resolveCurrentPage() != 1 ) {
                ...
                return view('parasanganta.content_english.photos', compact('foto'));
            }
        ...
        if( Paginator::resolveCurrentPage() != 1 ) {
            ...
            return view('parasanganta.content.photos', compact('foto'));
        }
    ...
    public function show($slug)
    {
        ...
        if( $lg == 'en' )
            return view('parasanganta.content_english.photo_detail', compact('foto'));

        return view('parasanganta.content.photo_detail', compact('foto'));
    }
