...
class KawasanController extends Controller
{
    public function index(){
        ...
        // }
           ...
           return view('parasanganta.content.tentang_kawasan', compact('foto'));
    ...
    public function show($slug)
    {
        ...
        $foto = Kawasan::where('slug', $slug)->firstOrFail();
        ...
        return view('parasanganta.content.kawasan_detail', compact('foto'));
    }
