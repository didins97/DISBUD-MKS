...
class BangunanController extends Controller
{
    public function index(){
        ...
        // }
           ...
           return view('parasanganta.content.tentang_bangunan', compact('foto'));
    ...
    public function show($slug)
    {
        ...
        $foto = Bangunan::where('slug', $slug)->firstOrFail();
        ...
        return view('parasanganta.content.bangunan_detail', compact('foto'));
    }
}
