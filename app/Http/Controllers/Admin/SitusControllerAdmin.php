...
class SitusControllerAdmin extends Controller
{
    public function index(){
        $bangunan= Situs::orderBy('created_at', 'desc')->get();
        return view('admin.content.situs.index', compact('bangunan'));
    }

    public function add() 
    {
        return view('admin.content.situs.add');
    }
    ...
    {
        $foto = Situs::findOrFail($bangunanId);
        


        return view('admin.content.situs.edit', compact('foto'));
    }
    ...
    {
        $bangunan = Situs::findOrFail($photoId);
