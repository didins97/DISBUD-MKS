...
class KawasanControllerAdmin extends Controller
{
    public function index(){
        $bangunan= Kawasan::orderBy('created_at', 'desc')->get();
        return view('admin.content.kawasan.index', compact('bangunan'));
    }

    public function add() 
    {
        return view('admin.content.kawasan.add');
    }
    ...
    {
        $foto = Kawasan::findOrFail($bangunanId);
        


        return view('admin.content.kawasan.edit', compact('foto'));
    }
    ...
    public function update(Request $request, $photoId)
    {
        ...
        $foto = Kawasan::findOrFail($photoId);
    ...
    {
        $bangunan = Kawasan::findOrFail($photoId);
