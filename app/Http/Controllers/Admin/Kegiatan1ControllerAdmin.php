...
class Kegiatan1ControllerAdmin extends Controller
{
    public function index(){
        $bangunan= Kegiatan1::orderBy('created_at', 'desc')->get();
        return view('admin.content.kegiatan1.index', compact('bangunan'));
    }

    public function add() 
    {
        return view('admin.content.kegiatan1.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.kegiatan1.index');
    }

    public function edit($bangunanId)
    {
        $foto = Kegiatan1::findOrFail($bangunanId);
        


        return view('admin.content.kegiatan1.edit', compact('foto'));
    }
    ...
    public function update(Request $request, $photoId)
    {
        ...
        $foto = Kegiatan1::findOrFail($photoId);
    ...
    {
        $bangunan = Kegiatan1::findOrFail($photoId);
