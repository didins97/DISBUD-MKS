...
Route::prefix('admin')->group(function () {
    ...
    // Admin Parasanganta & Super Admin
    Route::middleware('role:adminParasanganta&superAdmin')->group(function() {
      ...
      Route::get('/parasanganta/konten/cetak/{slug}', [\App\Http\Controllers\Admin\CetakKontenController::class, 'cetak'])->name('admin.konten.cetak');
    ...
    // Admin Labu & Super Admin
    Route::middleware('role:adminLabu&superAdmin')->group(function() {
